...
The user explicitly authorized implementing the tier-policy change in #162–167. Preserve safety, permission, acceptance and release invariants; update policy contracts with their tests for the requested behaviour. This snapshot preserves the previous repository rules while the installed instructions are updated and peer-reviewed.
